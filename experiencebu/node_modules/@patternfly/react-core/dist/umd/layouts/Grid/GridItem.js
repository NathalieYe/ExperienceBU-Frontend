(function (global, factory) {
  ...
  const GridItem = exports.GridItem = _ref => {
    ...
    const classes = [_grid2.default.gridItem, span && _grid2.default.modifiers[`${span}Col`], rowSpan && _grid2.default.modifiers[`${rowSpan}Row`], offset && _grid2.default.modifiers[`offset_${offset}Col`]];
    Object.entries(_sizes.DeviceSizes).forEach(([propKey, classModifier]) => {
      ...
      if (spanValue) {
        classes.push(_grid2.default.modifiers[`${spanValue}ColOn${classModifier}`]);
      }

      if (rowSpanValue) {
        classes.push(_grid2.default.modifiers[`${rowSpanValue}RowOn${classModifier}`]);
      }

      if (offsetValue) {
        classes.push(_grid2.default.modifiers[`offset_${offsetValue}ColOn${classModifier}`]);
      }
