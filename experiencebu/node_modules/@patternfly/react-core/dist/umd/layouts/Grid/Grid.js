(function (global, factory) {
  ...
  const Grid = exports.Grid = _ref => {
    ...
    const classes = [_grid2.default.grid, span && _grid2.default.modifiers[`all_${span}Col`]];
    Object.entries(_sizes.DeviceSizes).forEach(([propKey, gridSpanModifier]) => {
      const key = propKey;
      const propValue = props[key];

      if (propValue) {
        classes.push(_grid2.default.modifiers[`all_${propValue}ColOn${gridSpanModifier}`]);
      }
