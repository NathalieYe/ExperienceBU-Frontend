(function (global, factory) {
...
})(this, function (exports, _reactDom, _constants) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.canUseDOM = exports.toCamel = exports.formatBreakpointMods = undefined;
  ...
  const formatBreakpointMods = exports.formatBreakpointMods = (breakpointMods, styles) => breakpointMods.map(mod => `${mod.modifier}${mod.breakpoint ? `-on-${mod.breakpoint}` : ''}`).map(toCamel).map(modifierKey => styles.modifiers[modifierKey]).filter(Boolean).join(' ');
  ...
  const toCamel = exports.toCamel = s => s.replace(/([-_][a-z])/gi, camelize);
  /**
   * Copied from exenv
   */
