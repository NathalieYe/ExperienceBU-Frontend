(function (global, factory) {
  ...
  const OptionsMenuToggleWithText = exports.OptionsMenuToggleWithText = _ref => {
    ...
    return React.createElement("div", _extends({
      className: (0, _reactStyles.css)(_optionsMenu2.default.optionsMenuToggle, _optionsMenu2.default.modifiers.text, isPlain && _optionsMenu2.default.modifiers.plain, isHovered && _optionsMenu2.default.modifiers.hover, isActive && _optionsMenu2.default.modifiers.active, isFocused && _optionsMenu2.default.modifiers.focus, isDisabled && _optionsMenu2.default.modifiers.disabled)
  ...
  OptionsMenuToggleWithText.propTypes = {
    ...
    'aria-haspopup': _propTypes2.default.oneOfType([_propTypes2.default.bool, _propTypes2.default.oneOf(['dialog']), _propTypes2.default.oneOf(['menu']), _propTypes2.default.oneOf(['listbox']), _propTypes2.default.oneOf(['tree']), _propTypes2.default.oneOf(['grid'])]),
