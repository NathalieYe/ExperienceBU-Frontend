(function (global, factory) {
  ...
  const DropdownToggle = exports.DropdownToggle = _ref => {
    let {
      ...
      ref
        ...
        props = _objectWithoutProperties(_ref, ["id", "children", "className", "isOpen", "parentRef", "isFocused", "isHovered", "isActive", "isDisabled", "isPlain", "isPrimary", "onToggle", "iconComponent", "splitButtonItems", "splitButtonVariant", "aria-haspopup", "ref"]);
  ...
  DropdownToggle.propTypes = {
    ...
    'aria-haspopup': _propTypes2.default.oneOfType([_propTypes2.default.bool, _propTypes2.default.oneOf(['listbox']), _propTypes2.default.oneOf(['menu']), _propTypes2.default.oneOf(['dialog']), _propTypes2.default.oneOf(['grid']), _propTypes2.default.oneOf(['tree'])]),
