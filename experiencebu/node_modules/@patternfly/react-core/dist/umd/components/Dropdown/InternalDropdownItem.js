    ...
    render() {
      ...
      return React.createElement(_dropdownConstants.DropdownContext.Consumer, null, ({
        ...
        return React.createElement("li", {
          ...
          className: (0, _reactStyles.css)(classes, itemClass, variant === 'icon' && _dropdown2.default.modifiers.icon)
        })) : React.createElement(Component, _extends({}, additionalProps, {
          href: href || null,
          ref: this.ref,
          className: (0, _reactStyles.css)(classes, this.props.role !== 'separator' && itemClass, variant === 'icon' && _dropdown2.default.modifiers.icon),
          id: componentID
