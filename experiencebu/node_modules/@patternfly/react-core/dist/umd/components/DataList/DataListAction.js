(function (global, factory) {
  ...
  const DataListActionVisibility = exports.DataListActionVisibility = visibilityModifiers.filter(key => _dataList2.default.modifiers[key]).reduce((acc, curr) => {
    const key2 = curr.replace('_2xl', '2Xl');
    acc[key2] = _dataList2.default.modifiers[curr];
    return acc;
  }, {});
