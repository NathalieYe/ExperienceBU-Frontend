(function (global, factory) {
  ...
  const DataListCell = exports.DataListCell = _ref => {
    ...
    return React.createElement("div", _extends({
      className: (0, _reactStyles.css)(_dataList2.default.dataListCell, width > 1 && _dataList2.default.modifiers[`flex_${width}`], !isFilled && _dataList2.default.modifiers.noFill, alignRight && _dataList2.default.modifiers.alignRight, isIcon && _dataList2.default.modifiers.icon, className)
    }, props), children);
  };
