  ...
  const DrawerPanelContent = exports.DrawerPanelContent = _ref => {
    let {
      ...
      hasBorder = false
        ...
        props = _objectWithoutProperties(_ref, ["className", "children", "hasBorder"]);

    return React.createElement(_Drawer.DrawerContext.Consumer, null, ({
      isExpanded
    }) => React.createElement("div", _extends({
      className: (0, _reactStyles.css)(_drawer2.default.drawerPanel, hasBorder && _drawer2.default.modifiers.border, className),
      hidden: !isExpanded,
