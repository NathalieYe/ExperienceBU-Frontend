(function (global, factory) {
    ...
    render() {
      const _this$props = this.props,
        ...
        valueText
            ...
            props = _objectWithoutProperties(_this$props, ["id", "size", "className", "value", "title", "label", "variant", "measureLocation", "min", "max", "valueText"]);
      ...
      return React.createElement("div", _extends({}, additionalProps, {
        className: (0, _reactStyles.css)(_progress2.default.progress, _progress2.default.modifiers[variant], ['inside', 'outside'].includes(measureLocation) && _progress2.default.modifiers[measureLocation], measureLocation === 'inside' ? _progress2.default.modifiers[ProgressSize.lg] : _progress2.default.modifiers[size], !title && _progress2.default.modifiers.singleline, className),
        id: this.id,
        role: "progressbar"
  ...
  _defineProperty(Progress, "propTypes", {
    ...
    variant: _propTypes2.default.oneOf(['danger', 'success']),
