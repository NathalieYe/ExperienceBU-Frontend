(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "prop-types", "react", "@patternfly/react-styles/css/components/Switch/switch", "@patternfly/react-styles", "@patternfly/react-icons/dist/js/icons/check-icon", "../../helpers/util", "../../helpers"], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require("prop-types"), require("react"), require("@patternfly/react-styles/css/components/Switch/switch"), require("@patternfly/react-styles"), require("@patternfly/react-icons/dist/js/icons/check-icon"), require("../../helpers/util"), require("../../helpers"));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.propTypes, global.react, global._switch, global.reactStyles, global.checkIcon, global.util, global.helpers);
    global.undefined = mod.exports;
  }
})(this, function (exports, _propTypes, _react, _switch, _reactStyles, _checkIcon, _util, _helpers) {
  "use strict";
    ...
    render() {
      const _this$props = this.props,
        ...
        ouiaId
            ...
            props = _objectWithoutProperties(_this$props, ["id", "className", "label", "labelOff", "isChecked", "isDisabled", "onChange", "ouiaId"]);

      const isAriaLabelledBy = props['aria-label'] === '';
      return React.createElement("label", _extends({
        className: (0, _reactStyles.css)(_switch2.default.switch, className),
        htmlFor: this.id
      }, (0, _helpers.getOUIAProps)('Switch', ouiaId)), React.createElement("input", _extends({
        id: this.id,
