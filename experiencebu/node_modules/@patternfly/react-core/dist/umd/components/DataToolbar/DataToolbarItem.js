(function (global, factory) {
  ...
  const DataToolbarItem = exports.DataToolbarItem = _ref => {
    ...
    return React.createElement("div", _extends({
      className: (0, _reactStyles.css)(_dataToolbar2.default.dataToolbarItem, variant && _dataToolbar2.default.modifiers[(0, _util.toCamel)(variant)], (0, _util.formatBreakpointMods)(breakpointMods, _dataToolbar2.default), className)
    }, labelVariant && {
      'aria-hidden': true
    }, {
      id: id
