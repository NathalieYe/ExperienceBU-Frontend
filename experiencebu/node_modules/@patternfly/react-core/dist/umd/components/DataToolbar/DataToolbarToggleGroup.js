    ...
    render() {
      ...
      return React.createElement(_DataToolbarUtils.DataToolbarContext.Consumer, null, ({
        ...
        if (expandableContentRef.current && expandableContentRef.current.classList) {
          if (isExpanded) {
            expandableContentRef.current.classList.add(_dataToolbar2.default.modifiers.expanded);
          } else {
            expandableContentRef.current.classList.remove(_dataToolbar2.default.modifiers.expanded);
          }
        }

        return React.createElement("div", _extends({
          className: (0, _reactStyles.css)(_dataToolbar2.default.dataToolbarGroup, variant && _dataToolbar2.default.modifiers[(0, _util.toCamel)(variant)], (0, _util.formatBreakpointMods)(breakpointMods, _dataToolbar2.default), _dataToolbar2.default.modifiers.toggleGroup, _dataToolbar2.default.modifiers[`showOn${(0, _util.capitalize)(breakpoint)}`], className)
