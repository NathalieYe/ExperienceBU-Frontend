(function (global, factory) {
  ...
  const EmptyState = exports.EmptyState = _ref => {
    ...
    return React.createElement("div", _extends({
      className: (0, _reactStyles.css)(_emptyState2.default.emptyState, variant === 'lg' && _emptyState2.default.modifiers.lg, variant === 'sm' && _emptyState2.default.modifiers.sm, className)
    }, props), children);
  };
  ...
  EmptyState.propTypes = {
    ...
    variant: _propTypes2.default.oneOf(['sm', 'lg', 'full'])
  };
});
