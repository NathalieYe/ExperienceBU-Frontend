(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    ...
    factory(exports, require("prop-types"), require("react"), require("@patternfly/react-styles/css/components/Tabs/tabs"), require("@patternfly/react-styles/css/components/Button/button"), require("@patternfly/react-styles"), require("@patternfly/react-icons/dist/js/icons/angle-left-icon"), require("@patternfly/react-icons/dist/js/icons/angle-right-icon"), require("../../helpers/util"), require("../../helpers/constants"), require("./TabButton"), require("./TabContent"), require("../../helpers"));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.propTypes, global.react, global.tabs, global.button, global.reactStyles, global.angleLeftIcon, global.angleRightIcon, global.util, global.constants, global.TabButton, global.TabContent, global.helpers);
    global.undefined = mod.exports;
  }
})(this, function (exports, _propTypes, _react, _tabs, _button, _reactStyles, _angleLeftIcon, _angleRightIcon, _util, _constants, _TabButton, _TabContent, _helpers) {
  "use strict";
    ...
    render() {
      const _this$props = this.props,
        ...
        unmountOnExit
            ...
            props = _objectWithoutProperties(_this$props, ["className", "children", "activeKey", "id", "isFilled", "isSecondary", "leftScrollAriaLabel", "rightScrollAriaLabel", "aria-label", "variant", "ouiaId", "mountOnEnter", "unmountOnExit"]);
      ...
      }, (0, _helpers.getOUIAProps)('Tabs', ouiaId), {
        id: id && id
