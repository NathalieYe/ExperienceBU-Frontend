(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "prop-types", "react", "../Form", "../TextInput", "../Button", "../Checkbox", "../../helpers/constants"], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require("prop-types"), require("react"), require("../Form"), require("../TextInput"), require("../Button"), require("../Checkbox"), require("../../helpers/constants"));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.propTypes, global.react, global.Form, global.TextInput, global.Button, global.Checkbox, global.constants);
    global.undefined = mod.exports;
  }
})(this, function (exports, _propTypes, _react, _Form, _TextInput, _Button, _Checkbox, _constants) {
  "use strict";
  ...
  const LoginForm = exports.LoginForm = _ref => {
    ...
    return React.createElement(_Form.Form, _extends({
      ...
      label: usernameLabel,
      isRequired: true,
      validated: isValidUsername ? _constants.ValidatedOptions.default : _constants.ValidatedOptions.error,
      ...
      label: passwordLabel,
      isRequired: true,
      validated: isValidPassword ? _constants.ValidatedOptions.default : _constants.ValidatedOptions.error,
