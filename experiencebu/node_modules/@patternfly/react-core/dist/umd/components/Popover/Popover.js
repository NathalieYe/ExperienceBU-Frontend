(function (global, factory) {
  ...
  class Popover extends React.Component {
    ...
    render() {
      ...
      const content = this.state.isOpen ? React.createElement(_GenerateId2.default, null, randomId => React.createElement(FocusTrap, {
        active: this.state.focusTrapActive,
        focusTrapOptions: {
          clickOutsideDeactivates: true
        }
      }, React.createElement("div", _extends({
        className: (0, _reactStyles.css)(!enableFlip && (_popover2.default.modifiers[position] || _popover2.default.modifiers.top), className),
        role: "dialog",
        "aria-modal": "true",
