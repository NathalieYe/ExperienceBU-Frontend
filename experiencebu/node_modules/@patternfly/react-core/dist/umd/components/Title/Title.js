(function (global, factory) {
  ...
  exports.Title = exports.TitleSizes = undefined;
  ...
  let TitleSizes = exports.TitleSizes = undefined;
  ...
  const Title = exports.Title = _ref => {
    ...
    return React.createElement(HeadingLevel, _extends({}, props, {
      className: (0, _reactStyles.css)(_title2.default.title, _title2.default.modifiers[size], className)
    }), children);
  };

  Title.propTypes = {
    size: _propTypes2.default.oneOf(['md', 'lg', 'xl', '2xl', '3xl', '4xl']).isRequired,
    children: _propTypes2.default.node,
    className: _propTypes2.default.string,
    headingLevel: _propTypes2.default.oneOf(['h1', 'h2', 'h3', 'h4', 'h5', 'h6']).isRequired
  };
});
