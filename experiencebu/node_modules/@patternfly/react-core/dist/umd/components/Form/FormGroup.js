  ...
  const FormGroup = exports.FormGroup = _ref => {
    let {
      ...
      fieldId
        ...
        props = _objectWithoutProperties(_ref, ["children", "className", "label", "isRequired", "validated", "isInline", "helperText", "helperTextInvalid", "fieldId"]);
    ...
    return React.createElement(_FormContext.FormContext.Consumer, null, ({
      ...
      className: (0, _reactStyles.css)(_form2.default.formGroup, isInline ? _form2.default.modifiers.inline : className)
    ...
    }, children) : children, validated === _constants.ValidatedOptions.error && helperTextInvalid ? inValidHelperText : validated !== _constants.ValidatedOptions.error && helperText ? validHelperText : ''));
  };
