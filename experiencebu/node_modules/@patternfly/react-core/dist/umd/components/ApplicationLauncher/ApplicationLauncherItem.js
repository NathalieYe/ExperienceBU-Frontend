(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "prop-types", "react", "@patternfly/react-styles", "@patternfly/react-styles/css/components/AppLauncher/app-launcher", "../Dropdown", "./ApplicationLauncherContent", "./ApplicationLauncher", "@patternfly/react-icons/dist/js/icons/star-icon"], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require("prop-types"), require("react"), require("@patternfly/react-styles"), require("@patternfly/react-styles/css/components/AppLauncher/app-launcher"), require("../Dropdown"), require("./ApplicationLauncherContent"), require("./ApplicationLauncher"), require("@patternfly/react-icons/dist/js/icons/star-icon"));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.propTypes, global.react, global.reactStyles, global.appLauncher, global.Dropdown, global.ApplicationLauncherContent, global.ApplicationLauncher, global.starIcon);
    global.undefined = mod.exports;
  }
})(this, function (exports, _propTypes, _react, _reactStyles, _appLauncher, _Dropdown, _ApplicationLauncherContent, _ApplicationLauncher, _starIcon) {
  "use strict";
  ...
  const ApplicationLauncherItem = exports.ApplicationLauncherItem = _ref => {
    ...
    }, React.createElement(_ApplicationLauncher.ApplicationLauncherContext.Consumer, null, ({
      onFavorite
