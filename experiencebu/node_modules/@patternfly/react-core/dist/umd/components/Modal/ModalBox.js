  ...
  const ModalBox = exports.ModalBox = _ref => {
    let {
      ...
      id
        ...
        props = _objectWithoutProperties(_ref, ["children", "className", "variant", "title", "id"]);
    ...
    return React.createElement("div", _extends({}, props, {
      ...
      "aria-describedby": id,
      "aria-modal": "true",
      className: (0, _reactStyles.css)(_modalBox2.default.modalBox, className, variant === 'large' && _modalBox2.default.modifiers.lg, variant === 'small' && _modalBox2.default.modifiers.sm)
    }), children);
  };
