(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "prop-types", "react", "@patternfly/react-styles", "./ChipButton", "../Tooltip", "@patternfly/react-icons/dist/js/icons/times-circle-icon", "@patternfly/react-styles/css/components/Chip/chip", "../../helpers/GenerateId/GenerateId", "../../helpers"], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require("prop-types"), require("react"), require("@patternfly/react-styles"), require("./ChipButton"), require("../Tooltip"), require("@patternfly/react-icons/dist/js/icons/times-circle-icon"), require("@patternfly/react-styles/css/components/Chip/chip"), require("../../helpers/GenerateId/GenerateId"), require("../../helpers"));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.propTypes, global.react, global.reactStyles, global.ChipButton, global.Tooltip, global.timesCircleIcon, global.chip, global.GenerateId, global.helpers);
    global.undefined = mod.exports;
  }
})(this, function (exports, _propTypes, _react, _reactStyles, _ChipButton, _Tooltip, _timesCircleIcon, _chip, _GenerateId, _helpers) {
  "use strict";
  ...
  class Chip extends React.Component {
    constructor(props) {
      ...
      _defineProperty(this, "renderOverflowChip", () => {
        ...
        }, (0, _helpers.getOUIAProps)('OverflowChip', ouiaId)), React.createElement(_ChipButton.ChipButton, {
          onClick: onClick
      ...
      _defineProperty(this, "renderChip", randomId => {
        ...
        if (this.state.isTooltipVisible) {
          return React.createElement(_Tooltip.Tooltip, {
            ...
            tabIndex: "0"
          }, (0, _helpers.getOUIAProps)('Chip', ouiaId)), React.createElement("span", {
            ref: this.span,
            className: (0, _reactStyles.css)(_chip2.default.chipText),
            id: randomId
