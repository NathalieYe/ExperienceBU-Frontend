(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "prop-types", "react", "@patternfly/react-styles/css/components/Select/select", "@patternfly/react-styles/css/components/Badge/badge", "@patternfly/react-styles/css/components/FormControl/form-control", "@patternfly/react-styles/css/components/Button/button", "@patternfly/react-styles", "@patternfly/react-icons/dist/js/icons/times-circle-icon", "./SelectMenu", "./SelectOption", "./SelectToggle", "./selectConstants", "../ChipGroup", "../../helpers/util", "../../helpers", "../Divider"], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require("prop-types"), require("react"), require("@patternfly/react-styles/css/components/Select/select"), require("@patternfly/react-styles/css/components/Badge/badge"), require("@patternfly/react-styles/css/components/FormControl/form-control"), require("@patternfly/react-styles/css/components/Button/button"), require("@patternfly/react-styles"), require("@patternfly/react-icons/dist/js/icons/times-circle-icon"), require("./SelectMenu"), require("./SelectOption"), require("./SelectToggle"), require("./selectConstants"), require("../ChipGroup"), require("../../helpers/util"), require("../../helpers"), require("../Divider"));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.propTypes, global.react, global.select, global.badge, global.formControl, global.button, global.reactStyles, global.timesCircleIcon, global.SelectMenu, global.SelectOption, global.SelectToggle, global.selectConstants, global.ChipGroup, global.util, global.helpers, global.Divider);
    global.undefined = mod.exports;
  }
})(this, function (exports, _propTypes, _react, _select, _badge, _formControl, _button, _reactStyles, _timesCircleIcon, _SelectMenu, _SelectOption, _SelectToggle, _selectConstants, _ChipGroup, _util, _helpers, _Divider) {
  "use strict";
  ...
  class Select extends React.Component {
    constructor(...args) {
      ...
      _defineProperty(this, "componentDidUpdate", (prevProps, prevState) => {
        ...
        if (prevProps.selection !== this.props.selection && this.props.variant === _selectConstants.SelectVariant.typeahead) {
          this.setState({
    ...
    render() {
      ...
      return React.createElement("div", _extends({
        className: (0, _reactStyles.css)(_select2.default.select, isOpen && _select2.default.modifiers.expanded, direction === _selectConstants.SelectDirection.up && _select2.default.modifiers.top, className),
        ref: this.parentRef,
        style: {
          width
        }
      }, (0, _helpers.getOUIAProps)('Select', ouiaId)), React.createElement(_selectConstants.SelectContext.Provider, {
        value: {
          onSelect,
      ...
      }, placeholderText)), variant === _selectConstants.SelectVariant.single && !customContent && React.createElement(React.Fragment, null, React.createElement("div", {
        className: (0, _reactStyles.css)(_select2.default.selectToggleWrapper)
      }, toggleIcon && React.createElement("span", {
        className: (0, _reactStyles.css)(_select2.default.selectToggleIcon)
      }, toggleIcon), React.createElement("span", {
        className: (0, _reactStyles.css)(_select2.default.selectToggleText)
      }, this.getDisplay(selection, 'node') || placeholderText || childPlaceholderText)), hasOnClear && hasAnySelections && clearBtn), variant === _selectConstants.SelectVariant.checkbox && !customContent && React.createElement(React.Fragment, null, React.createElement("div", {
        className: (0, _reactStyles.css)(_select2.default.selectToggleWrapper)
      }, toggleIcon && React.createElement("span", {
        className: (0, _reactStyles.css)(_select2.default.selectToggleIcon)
      }, toggleIcon), React.createElement("span", {
        ...
        value: typeaheadInputValue !== null ? typeaheadInputValue : this.getDisplay(selection, 'text') || '',
        type: "text",
        ...
        autoComplete: "off",
        disabled: isDisabled
      })), (selection || typeaheadInputValue) && clearBtn), variant === _selectConstants.SelectVariant.typeaheadMulti && !customContent && React.createElement(React.Fragment, null, React.createElement("div", {
        className: (0, _reactStyles.css)(_select2.default.selectToggleWrapper)
      }, toggleIcon && React.createElement("span", {
        className: (0, _reactStyles.css)(_select2.default.selectToggleIcon)
        ...
        autoComplete: "off",
        disabled: isDisabled
      })), (selections && selections.length > 0 || typeaheadInputValue) && clearBtn)), isOpen && React.createElement(_SelectMenu.SelectMenu, _extends({}, props, variantProps, {
  ...
  _defineProperty(Select, "propTypes", {
    ...
    selection: _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.any]),
    selections: _propTypes2.default.oneOfType([_propTypes2.default.arrayOf(_propTypes2.default.string), _propTypes2.default.arrayOf(_propTypes2.default.any)]),
    toggleId: _propTypes2.default.string,
    'aria-label': _propTypes2.default.string,
    'aria-labelledby': _propTypes2.default.string,
    typeAheadAriaLabel: _propTypes2.default.string,
    clearSelectionsAriaLabel: _propTypes2.default.string,
    toggleAriaLabel: _propTypes2.default.string,
    removeSelectionAriaLabel: _propTypes2.default.string,
