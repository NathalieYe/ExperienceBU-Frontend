  ...
  render() {
    ...
    return React.createElement(DataToolbarContext.Consumer, null, ({
      ...
      return React.createElement("div", _extends({
        className: css(styles.dataToolbarGroup, variant && styles.modifiers[toCamel(variant)], formatBreakpointMods(breakpointMods, styles), styles.modifiers.toggleGroup, styles.modifiers[`showOn${capitalize(breakpoint)}`], className)
