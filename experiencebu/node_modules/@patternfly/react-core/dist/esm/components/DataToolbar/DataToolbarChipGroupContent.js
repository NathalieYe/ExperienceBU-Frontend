...
export class DataToolbarChipGroupContent extends React.Component {
  render() {
    ...
    return React.createElement("div", _extends({
      className: css(styles.dataToolbarContent, (numberOfFilters === 0 || isExpanded) && styles.modifiers.hidden, className)
      ...
      'aria-hidden': true
    })), collapseListedFilters && numberOfFilters > 0 && !isExpanded && React.createElement(DataToolbarGroup, null, React.createElement(DataToolbarItem, null, numberOfFilters, " filters applied")), showClearFiltersButton && !isExpanded && React.createElement(DataToolbarItem, null, React.createElement(Button, {
      variant: "link",
