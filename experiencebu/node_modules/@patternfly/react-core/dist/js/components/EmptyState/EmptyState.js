...
var EmptyState = function EmptyState(_ref) {
  var children = _ref.children,
      ...
      variant = _ref$variant === void 0 ? EmptyStateVariant.full : _ref$variant,
      props = _objectWithoutProperties(_ref, ["children", "className", "variant"]);

  return React.createElement("div", _extends({
    className: (0, _reactStyles.css)(_emptyState["default"].emptyState, variant === 'lg' && _emptyState["default"].modifiers.lg, variant === 'sm' && _emptyState["default"].modifiers.sm, className)
  }, props), children);
};
...
EmptyState.propTypes = {
  ...
  variant: _propTypes["default"].oneOf(['sm', 'lg', 'full'])
};
