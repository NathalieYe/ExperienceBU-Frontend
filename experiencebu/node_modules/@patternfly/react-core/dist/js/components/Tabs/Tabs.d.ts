...
export declare class Tabs extends React.Component<TabsProps & OUIAProps, TabsState> {
    tabList: React.RefObject<HTMLUListElement>;
    constructor(props: TabsProps & OUIAProps);
    static defaultProps: PickOptional<TabsProps>;
    handleTabClick(event: React.MouseEvent<HTMLElement, MouseEvent>, eventKey: number, tabContentRef: React.RefObject<any>, mountOnEnter: boolean): void;
