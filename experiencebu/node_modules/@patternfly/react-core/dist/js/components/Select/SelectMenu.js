  ...
  _createClass(SelectMenu, [{
    ...
    value: function render() {
      ...
      return React.createElement(_selectConstants.SelectConsumer, null, function (_ref) {
        ...
        }, props), _this2.extendChildren()), variant === _selectConstants.SelectVariant.checkbox && !isCustomContent && React.Children.count(children) > 0 && React.createElement(FocusTrap, {
          focusTrapOptions: {
