...
var DataListCell = function DataListCell(_ref) {
  ...
  return React.createElement("div", _extends({
    className: (0, _reactStyles.css)(_dataList["default"].dataListCell, width > 1 && _dataList["default"].modifiers["flex_".concat(width)], !isFilled && _dataList["default"].modifiers.noFill, alignRight && _dataList["default"].modifiers.alignRight, isIcon && _dataList["default"].modifiers.icon, className)
  }, props), children);
};
