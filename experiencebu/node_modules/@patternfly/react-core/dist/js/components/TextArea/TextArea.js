...
function (_React$Component) {
  ...
  _createClass(TextArea, [{
    ...
    value: function render() {
      ...
      var orientation = "resize".concat((0, _helpers.capitalize)(resizeOrientation));
      return React.createElement("textarea", _extends({
        className: (0, _reactStyles.css)(_formControl["default"].formControl, className, resizeOrientation !== TextAreResizeOrientation.both && _formControl["default"].modifiers[orientation], validated === _constants.ValidatedOptions.success && _formControl["default"].modifiers.success),
