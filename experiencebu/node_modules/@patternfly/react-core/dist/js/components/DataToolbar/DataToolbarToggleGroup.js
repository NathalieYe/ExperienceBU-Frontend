      ...
      return React.createElement(_DataToolbarUtils.DataToolbarContext.Consumer, null, function (_ref) {
        ...
        return React.createElement(_DataToolbarUtils.DataToolbarContentContext.Consumer, null, function (_ref2) {
          ...
          if (expandableContentRef.current && expandableContentRef.current.classList) {
            if (isExpanded) {
              expandableContentRef.current.classList.add(_dataToolbar["default"].modifiers.expanded);
            } else {
              expandableContentRef.current.classList.remove(_dataToolbar["default"].modifiers.expanded);
            }
          }

          return React.createElement("div", _extends({
            className: (0, _reactStyles.css)(_dataToolbar["default"].dataToolbarGroup, variant && _dataToolbar["default"].modifiers[(0, _util.toCamel)(variant)], (0, _util.formatBreakpointMods)(breakpointMods, _dataToolbar["default"]), _dataToolbar["default"].modifiers.toggleGroup, _dataToolbar["default"].modifiers["showOn".concat((0, _util.capitalize)(breakpoint))], className)
