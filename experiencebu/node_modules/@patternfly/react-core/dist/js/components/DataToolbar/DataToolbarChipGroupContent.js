  ...
  _createClass(DataToolbarChipGroupContent, [{
    ...
    value: function render() {
      ...
      return React.createElement("div", _extends({
        className: (0, _reactStyles.css)(_dataToolbar["default"].dataToolbarContent, (numberOfFilters === 0 || isExpanded) && _dataToolbar["default"].modifiers.hidden, className)
      }, (numberOfFilters === 0 || isExpanded) && {
        hidden: true
      }, {
        ref: chipGroupContentRef
      }, props), React.createElement(_DataToolbarGroup.DataToolbarGroup, _extends({
        className: (0, _reactStyles.css)(collapseListedFilters && _dataToolbar["default"].modifiers.hidden)
