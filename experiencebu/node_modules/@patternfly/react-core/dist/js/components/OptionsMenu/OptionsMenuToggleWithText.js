...
var OptionsMenuToggleWithText = function OptionsMenuToggleWithText(_ref) {
  ...
  return React.createElement("div", _extends({
    className: (0, _reactStyles.css)(_optionsMenu["default"].optionsMenuToggle, _optionsMenu["default"].modifiers.text, isPlain && _optionsMenu["default"].modifiers.plain, isHovered && _optionsMenu["default"].modifiers.hover, isActive && _optionsMenu["default"].modifiers.active, isFocused && _optionsMenu["default"].modifiers.focus, isDisabled && _optionsMenu["default"].modifiers.disabled)
...
OptionsMenuToggleWithText.propTypes = {
  ...
  'aria-haspopup': _propTypes["default"].oneOfType([_propTypes["default"].bool, _propTypes["default"].oneOf(['dialog']), _propTypes["default"].oneOf(['menu']), _propTypes["default"].oneOf(['listbox']), _propTypes["default"].oneOf(['tree']), _propTypes["default"].oneOf(['grid'])]),
