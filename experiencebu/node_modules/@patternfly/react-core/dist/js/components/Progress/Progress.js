  ...
  _createClass(Progress, [{
    ...
    value: function render() {
      ...
      return React.createElement("div", _extends({}, additionalProps, {
        className: (0, _reactStyles.css)(_progress["default"].progress, _progress["default"].modifiers[variant], ['inside', 'outside'].includes(measureLocation) && _progress["default"].modifiers[measureLocation], measureLocation === 'inside' ? _progress["default"].modifiers[ProgressSize.lg] : _progress["default"].modifiers[size], !title && _progress["default"].modifiers.singleline, className),
        id: this.id,
        role: "progressbar"
...
_defineProperty(Progress, "propTypes", {
  ...
  variant: _propTypes["default"].oneOf(['danger', 'success']),
