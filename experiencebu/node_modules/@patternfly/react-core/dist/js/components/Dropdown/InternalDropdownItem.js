    ...
    value: function render() {
      ...
      return React.createElement(_dropdownConstants.DropdownContext.Consumer, null, function (_ref) {
        ...
        return React.createElement("li", {
          ...
          className: (0, _reactStyles.css)(classes, itemClass, variant === 'icon' && _dropdown["default"].modifiers.icon)
        })) : React.createElement(Component, _extends({}, additionalProps, {
          href: href || null,
          ref: _this2.ref,
          className: (0, _reactStyles.css)(classes, _this2.props.role !== 'separator' && itemClass, variant === 'icon' && _dropdown["default"].modifiers.icon),
          id: componentID
