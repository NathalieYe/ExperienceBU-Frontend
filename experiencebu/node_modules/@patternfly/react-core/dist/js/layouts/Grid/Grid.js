...
var Grid = function Grid(_ref) {
  ...
  var classes = [_grid["default"].grid, span && _grid["default"].modifiers["all_".concat(span, "Col")]];
  Object.entries(_sizes.DeviceSizes).forEach(function (_ref2) {
    ...
    if (propValue) {
      classes.push(_grid["default"].modifiers["all_".concat(propValue, "ColOn").concat(gridSpanModifier)]);
    }
