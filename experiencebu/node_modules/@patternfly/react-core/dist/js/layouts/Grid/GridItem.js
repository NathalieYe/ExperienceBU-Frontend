...
var GridItem = function GridItem(_ref) {
  ...
  var classes = [_grid["default"].gridItem, span && _grid["default"].modifiers["".concat(span, "Col")], rowSpan && _grid["default"].modifiers["".concat(rowSpan, "Row")], offset && _grid["default"].modifiers["offset_".concat(offset, "Col")]];
  Object.entries(_sizes.DeviceSizes).forEach(function (_ref2) {
    ...
    if (spanValue) {
      classes.push(_grid["default"].modifiers["".concat(spanValue, "ColOn").concat(classModifier)]);
    }

    if (rowSpanValue) {
      classes.push(_grid["default"].modifiers["".concat(rowSpanValue, "RowOn").concat(classModifier)]);
    }

    if (offsetValue) {
      classes.push(_grid["default"].modifiers["offset_".concat(offsetValue, "ColOn").concat(classModifier)]);
    }
