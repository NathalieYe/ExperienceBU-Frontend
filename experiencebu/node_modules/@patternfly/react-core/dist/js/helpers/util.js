...
exports.canUseDOM = exports.toCamel = exports.formatBreakpointMods = void 0;
...
var formatBreakpointMods = function formatBreakpointMods(breakpointMods, styles) {
  return breakpointMods.map(function (mod) {
    return "".concat(mod.modifier).concat(mod.breakpoint ? "-on-".concat(mod.breakpoint) : '');
  }).map(toCamel).map(function (modifierKey) {
